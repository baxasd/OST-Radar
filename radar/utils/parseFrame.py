...
# Local File Imports
from radar.utils.parseTLVs import *
# from gui_common import *
from radar.utils.tlv_defines import *
...
parserFunctions = {
    ...
    MMWDEMO_OUTPUT_MSG_AZIMUT_ELEVATION_STATIC_HEAT_MAP:     parseRahmTLV,
    MMWDEMO_OUTPUT_MSG_AZIMUT_STATIC_HEAT_MAP:               parseRahmTLV,
    MMWDEMO_OUTPUT_MSG_RANGE_DOPPLER_HEAT_MAP:               parseDopplerTLV
}
...
def parseStandardFrame(frameData):
    ...
    for i in range(numTLVs):
        ...
        if (tlvType in parserFunctions):
            # print("TLV type: ", parserFunctions[tlvType])
            # if tlvType == 8:
            #     import shelve
            #     with shelve.open('rahmdata') as r:
            #         r['my_rahm'] = frameData[:tlvLength]
            # elif tlvType == 2:
            #     import shelve
            #     with shelve.open('rangedata') as r:
            #         print(frameData[:tlvLength])
            #         r['my_range'] = frameData[:tlvLength]
